...
class BuniEditor : EditorWindow
{
    ...
    [MenuItem("Buni/Scene Manager")]
    public static void ShowWindow()
    {
        EditorWindow.GetWindow(typeof(BuniEditor));
    }
    ...
    static public void StartGame()
    {
        if (!UnityEngine.Application.isPlaying)
        {
            ...
            {
                EditorSceneManager.OpenScene("Assets/Scene/Launch.unity");
    ...
    static public void PlayScene()
    {
        if (EditorSceneManager.SaveCurrentModifiedScenesIfUserWantsTo())
        {
            EditorSceneManager.OpenScene("Assets/_Game/Scenes/Play.unity");
        }
    }
    ...
    static public void LoadScene(string scenename)
    {
        if (!EditorApplication.isPlayingOrWillChangePlaymode)
        {
            if (EditorSceneManager.SaveCurrentModifiedScenesIfUserWantsTo())
            {
                EditorSceneManager.OpenScene("Assets/Scene/" + scenename + ".unity");
            }
        }
        else
        {
